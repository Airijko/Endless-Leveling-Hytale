...
/**
 * Parsed True Edge passive settings.
 */
public record TrueEdgeSettings(boolean enabled,
    ...
    private static final TrueEdgeSettings DISABLED = new TrueEdgeSettings(false, 0.0D, 0.0D, 0.0D, 0L, 0.0D);

    public static TrueEdgeSettings fromSnapshot(ArchetypePassiveSnapshot snapshot) {
        if (snapshot == null) {
            return DISABLED;
        }
        ...
        return new TrueEdgeSettings(true,
                flatTrueDamage,
                trueDamagePercent,
