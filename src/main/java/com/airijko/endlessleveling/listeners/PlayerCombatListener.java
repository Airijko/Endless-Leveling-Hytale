...
public class PlayerCombatListener extends DamageEventSystem {
    private final SkillManager skillManager = Endless_Leveling_Hytale.getInstance().getSkillManager();
    ...
    public void handle(
        ...
        if (damage.getSource() instanceof Damage.EntitySource entitySource) {
            ...
            if (attackerPlayer != null && attackerPlayer.isValid()) {
                ...
                PlayerData playerData = com.airijko.endlessleveling.Endless_Leveling_Hytale.getInstance().getPlayerDataManager()
